{
  ...
  function generateTitleLinks(customSelector = ''){
    ...
    for(let article of articles){
      ...
      /*[NEW] add link HTML with a help of Hanf=dlebars*/
  ...
  function generateTags(){
    ...
    for(let article of articles){
      ...
      for(let tag of articleTagsArray){
        ...
        /*[New] generate HTML with a help of Handlebars*/
  ...
  function generateAuthors() {
    ...
    authorListColumn.innerHTML = templates.authorCloudLink(allAuthorsData);
